...
const Home = () => {
  return (
    <div className="flex flex-col min-h-screen font-sans bg-gray-50">
      ...
      <div className="h-16"></div> {/* Adds blank space at the top of the page */}
      ...
      <div className="flex-grow bg-white flex flex-col justify-center items-center px-6">
        ...
        <p className="text-center text-lg mt-6 leading-relaxed text-gray-700">
          ...
          <span className="font-bold text-[#EC5500]">Stony Brook University</span>
          <br /> with a strong passion for software development.
          <br />
          My objective is to secure a software development role where I can apply my technical expertise, hands-on
          project experience, <br/> and problem-solving skills to build innovative and efficient solutions.
        </p>

        <p className="text-center text-lg mt-6 leading-relaxed text-gray-700">
          Through my portfolio, I aim to showcase my proficiency in programming languages like Python and JavaScript, <br/> my
          experience with full-stack development, and my dedication to creating impactful applications. <br />
        ...
        <div className="mt-8"></div> {/* Adds space after the interactive buttons */}
      </div>
